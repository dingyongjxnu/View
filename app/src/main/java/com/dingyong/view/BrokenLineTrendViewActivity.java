...
import com.dingyong.view.custom.brokeLineView.BrokenLineDimension;
import com.dingyong.view.custom.brokeLineView.BrokenLineTrendData;
import com.dingyong.view.custom.brokeLineView.BrokenLineTrendView;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class BrokenLineTrendViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score_trend_view);
        ...
        mBrokenLineTrendView.setOnItemClick(new BrokenLineTrendView.OnItemClick() {
            ...
            public void onBrokenLinePointClick(int position, BrokenLineDimension dimension, List<String> xData) {
                Toast.makeText(BrokenLineTrendViewActivity.this, xData.get(position) + dimension.remark +"." + dimension.mDatasList.get(position), Toast.LENGTH_SHORT).show();
            }
